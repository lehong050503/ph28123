                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mt-3 text-center">
                            ...
                            <h3>Success !</h3>
                            <p class="text-muted mt-2"> A email has been send to <span class="font-weight-medium">{{ $user->email }}</span>.
                                Please check the mail for the exact information of the new flight ticket. </p>

                            <a href="{{ route('home') }}" class="btn btn-block btn-primary waves-effect waves-light mt-3">Back to Home</a>
                        </div>
