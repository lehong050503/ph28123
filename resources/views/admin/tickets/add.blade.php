...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            <h4 class="header-title">Add New Tickets</h4>
            <p class="sub-header">
                Parsley is a javascript form validation library. It helps you provide your users with feedback on their form submission before sending it to your server.
            </p>

            <form class="parsley-form" id="postAddTicket" action="{{ route('addTicket')}}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div>
                        ...
                        <select name="id_flight" class="selectpicker form-control" data-style="btn-light">
                            ...
                            @foreach ($flights as $fly)
                                <option value="{{ $fly->id_flight }}">{{ $fly->status_flight }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <select name="class" class="selectpicker form-control" data-style="btn-light">
                            ...
                            <option value="Firt class">Firt class</option>
                        </select>
                ...
                <div class="form-group">
                    <label>Price</label>
                    <input type="text" class="form-control" name="price" placeholder="Type something">
                    <p class="help-block text-danger"></p>
                </div>
                <div class="form-group">
                    <label>Seat</label>
                    <input type="text" class="form-control" name="seat" placeholder="Type something">
                    <p class="help-block text-danger"></p>
                </div>
                <div class="form-group">
                    <label>Status Ticket</label>
                    <input type="text" class="form-control" name="status_ticket" placeholder="Type something">
                    <p class="help-block text-danger"></p>
                </div>
...
@section('js')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\TicketRequest','#postAddTicket') !!}
